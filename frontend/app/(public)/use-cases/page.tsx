      ...
      <section className="py-24 bg-[#f7f8f6] px-4 sm:px-6 lg:px-8 border-t border-emerald-900/5 flex-1">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-serif text-slate-900">How businesses use Bizentrix AI</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center text-center">
              ...
              <p className="text-slate-600">Scan a QR code to link your business WhatsApp number securely in seconds.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Upload Knowledge</h3>
              <p className="text-slate-600">Upload your pricing list and business details. The AI learns everything instantly.</p>
            </div>
